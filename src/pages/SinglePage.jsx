...
function SinglePage() {
  ...
  return (
    <>
      ...
      <button onClick={deleteBook} className="px-3 py-1 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg m-3">
        Delete
      </button>

      
        <div>
          <Link to ={`/editpage/${food.id}`}>
        <button className="px-4  py-1 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg m-3">
          Edit
        </button>
   </Link>
   </div>
